...
# on 64 bit linux.
http_archive(
    name = "athena_toolchain_linux64_files",
    build_file = "@//:build_tools/toolchain/athena_toolchain_linux64_files.BUILD",
...
http_archive(
    name = "athena_toolchain_win32_files",
    build_file = "@//:build_tools/toolchain/athena_toolchain_win32_files.BUILD",
...
http_archive(
    name = "athena_toolchain_macos64_files",
    build_file = "@//:build_tools/toolchain/athena_toolchain_macos64_files.BUILD",
...
register_toolchains(
    "//build_tools/toolchain:athena-cc-toolchain-linux64",
    "//build_tools/toolchain:athena-cc-toolchain-win32",
    "//build_tools/toolchain:athena-cc-toolchain-macos64",
)
